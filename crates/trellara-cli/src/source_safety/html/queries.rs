...
pub(crate) fn push_source_safety_query_appendix(html: &mut String) {
    html.push_str("<section class=\"card\"><h2>Exact Read-Only Queries</h2>");
    html.push_str("<p>These are the query templates Trellara runs for source-safety evidence. Queries with parameters bind the values listed below.</p>");
